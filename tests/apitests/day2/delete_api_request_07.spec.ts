...
function readJson(filePath: string) {
    return JSON.parse(fs.readFileSync(filePath, 'utf-8'));// this return is used for chaining
}
...
test('Delete booking(end-to-end)', async ({ request }) => {
    ...
    //sending put request-update(put)
