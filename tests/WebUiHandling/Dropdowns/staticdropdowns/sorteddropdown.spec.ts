...
test("Verify dropdown is Sorted",async ({page})=>{
  ...
  // Note: here ()...) is spread operator we use it because if we want to sort the array with the help of spread operator it will not impact the original array if we donot use it will not impact it
