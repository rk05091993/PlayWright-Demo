...
await page.goto('https://www.w3.org/');//---> Donot have any violation                                                                                                                                    
...
//Note: No websites will follow  100% standards will have  some violations
//we can acheive accessibilty testing by integerating AxeBuilder from '@axe-core/playwright
