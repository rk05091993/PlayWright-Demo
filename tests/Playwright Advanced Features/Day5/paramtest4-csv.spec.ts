...
const csvPath='testdata/data.csv';//file location
const fileContent=fs.readFileSync(csvPath,'utf-8');


//This command will read the file content and gives you all the records and we have stored in variabke called records
